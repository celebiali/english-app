...
// Tap Günün Kelime Hedefi card (around y ~ 690 inside sim window)
let cardPos = CGPoint(x: simBounds.origin.x + simBounds.width * 0.5, y: simBounds.origin.y + simBounds.height * 0.73)
click(at: cardPos)
