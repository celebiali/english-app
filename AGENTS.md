...
> **BU BELGE (`AGENTS.md`):** Yapay zeka asistanları (Antigravity vb.) her oturumda bu kuralları otomatik okur. Kullanıcı uzun açıklamalar yapmadan doğrudan isteklerini yazar; kod daima aşağıdaki standartlara uygun üretilir.
