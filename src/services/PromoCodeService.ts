...
const SEED_PROMO_CODES: Record<string, PromoCodeInfo> = {
  ...
  YDS20: {
    code: 'YDS20',
    discountPercent: 20,
    teacherName: 'Dil Sınavı Hazırlık Özel',
    channelName: 'Dil Sınavı Hazırlık Resmi İndirim',
    commissionPercent: 0,
    isValid: true,
  },
  YOKDIL20: {
...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    id: 'plan_6m',
    appleProductId: ENV_CONFIG.APPLE_PRODUCT_IDS.PLAN_6M,
    title: '6 Aylık Hazırlık Paketi',
    subtitle: 'Sınav Dönemine Özel Tam Hazırlık',
    durationMonths: 6,
    originalPrice: 299,
    monthlyPrice: 50,
    badge: '7 GÜN ÜCRETSİZ DENE ⭐',
    trialDays: 7,
    isPopular: true,
    features: [
      'İlk 7 Gün 0 ₺, Dilediğin Zaman İptal Et',
      'Tüm Master Deneme Sınavları (80 Soru)',
      'Sınırsız Gemini AI Çeldirici & Tuzak Analizi',
      'Kişiselleştirilmiş AI Test Üretimi',
      'Hata Kasası (Mistake Vault) & Aralıklı Telafi',
      'Çevrimdışı Çalışma & Bulut Senkronizasyonu',
    ],
  },
  {
    id: 'plan_12m',
    appleProductId: ENV_CONFIG.APPLE_PRODUCT_IDS.PLAN_12M,
    title: '12 Aylık Sınırsız VIP',
    subtitle: 'YDS + YÖKDİL + YDT Tüm Yıl VIP',
    durationMonths: 12,
    originalPrice: 499,
    monthlyPrice: 42,
    trialDays: 7,
    ...
    features: [
      'İlk 7 Gün 0 ₺, Dilediğin Zaman İptal Et',
      '1 Yıl Boyunca Yeni Eklenen Tüm Master Denemeler',
      'Sınırsız Gemini AI Sınav Koçluğu',
      'Sınırsız Özel Kelime Defteri & Bulut Yedekleme',
      'Öncelikli AI Sunucu İşleme Hızı',
      'Tüm Sınav Formatlarına (YDS/YÖKDİL) VIP Erişim',
    ],
  },
  {
    id: 'plan_1m',
    appleProductId: 'ydspratik_299_1m',
    title: '1 Aylık Hızlı Sprint',
    subtitle: 'Son Tekrarlar ve Hızlı Kamp',
    durationMonths: 1,
    originalPrice: 299,
    monthlyPrice: 299,
    trialDays: 0,
    features: [
      'Tüm Master Denemelere 30 Gün Erişim',
      'Gemini AI Çeldirici Analizi',
